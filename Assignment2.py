...
tk.Label(root, text="Material Cost:").grid(row=0, column=0)
tk.Entry(root, textvariable=material_cost).grid(row=0, column=1)


tk.Label(root, text="Miles Travelled:").grid(row=1, column=0)
tk.Entry(root, textvariable=miles_travelled).grid(row=1, column=1)

tk.Label(root, text="Rate per Mile:").grid(row=2, column=0)
tk.Entry(root, textvariable=rate_per_mile).grid(row=2, column=1)

tk.Label(root, text="Project Duration (days):").grid(row=3, column=0)
tk.Entry(root, textvariable=project_duration).grid(row=3, column=1)


tk.Label(root, text="Number of Workers:").grid(row=4, column=0)
tk.Entry(root, textvariable=num_workers).grid(row=4, column=1)

tk.Label(root, text="Rate per Worker per Day:").grid(row=5, column=0)
tk.Entry(root, textvariable=rate_per_worker).grid(row=5, column=1)


tk.Label(root, text="Discount:").grid(row=6, column=0)
tk.OptionMenu(root, discount, "0%", "5%", "10%", "20%").grid(row=6, column=1)

output = tk.Text(root, height=10, width=50)
output.grid(row=9, column=0, columnspan=2)
...
tk.Button(root, text="Calculate Estimate", command=calculate_estimate).grid(row=7, column=0, columnspan=2)
...
tk.Button(root, text="Save Estimate", command=save_estimate).grid(row=8, column=0, columnspan=2)
